...
class MealPlansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meal_plan" do
    assert_difference("MealPlan.count") do
      post meal_plans_url, params: { meal_plan: { meals: @meal_plan.meals, rating: @meal_plan.rating } }
    end
  ...
  test "should update meal_plan" do
    patch meal_plan_url(@meal_plan), params: { meal_plan: { meals: @meal_plan.meals, rating: @meal_plan.rating } }
